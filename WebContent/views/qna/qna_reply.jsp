...
<jsp:include page="../common/header.jsp"/>
	...
	<form class="form1" method="post">
                        ...
                        <div class="bbs-table-view">
				     	...
				     	<input type="button" value="답변하기" id="rep_btn" class="btn btn_normal" onclick="location.href='../shop/shop_front_detail.jsp#tab4'">
						<input type="button" value="목록보기" class="btn btn_normal" onclick="location.href='../shop/shop_front_detail.jsp#tab4'">
                    </div><!-- .page-body -->
                </div><!-- #bbsData -->
