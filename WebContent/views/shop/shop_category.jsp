													...
													<tbody>
														<tr><td bgcolor="white">
															<table width="100%" cellspacing="2" cellpadding="1" bgcolor="white" border="0">
																<tbody>
																	<tr>
																		<c:forEach var="origin2" items="${origin2}">
																		<td nowrap>
																			&nbsp;
																			<img src="${path}/resource/img/shop/dot_04.gif" align="absmiddle" vspace="2"/>
																			<a href="${path}/shop_category.do?category=${origin2.category}&origin=${origin2.origin}">
																				<font color="#000000" style="font-size:9pt">${origin2.origin}</font>
																			</a>
																		</td>
																		</c:forEach>
																	</tr>
